...
const intro_data: DataType[] = [
   {
      ...
      desc: "Desenvolvimento de software e serviços orientado a testes certificando máxima qualidade",
   },
   {
      id: 2,
      page: "home_2",
      ...
      desc: "Respeitamos os prazos garantindo entrega do serviço será conforme acordado.",
   },
   {
      id: 3,
      page: "home_2",
      ...
      desc: "Tecnologia de ponta em um custo acessivel a pequenos e medios empreendedores",
   },
