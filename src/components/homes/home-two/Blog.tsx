            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-7 col-md-10">
                  <div className="section-title text-center">
                     ...
                     <h2 className="title">Fique Por Dentro do assunto</h2>
                     <p className="content">Nossas Publicações mensais para manter você sempre bem informado dos assuntos de tecnologia.</p>
                  </div>
               </div>
            </div>
