               ...
               <div className="row justify-content-center">
                  <div className="col-lg-6 col-md-10">
                     <div className="section-title style-white text-center">
                        <h5 className="sub-title double-border">Fluxo de Trabalho</h5>
                        <h2 className="title">Como Funciona o processo.</h2>
                        <p className="content">Temos um fluxo de trabalho que garante qualidade, prazo e eficiencia.</p>
                     </div>
                  </div>
               </div>
